...
mixin _$AuditLog {
 ...
 String get id; String get actorUid; String get actorRole; String get action; String get targetType; String get targetId; String? get reason; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,actorUid,actorRole,action,targetType,targetId,reason,createdAt);

@override
String toString() {
  return 'AuditLog(id: $id, actorUid: $actorUid, actorRole: $actorRole, action: $action, targetType: $targetType, targetId: $targetId, reason: $reason, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String actorUid, String actorRole, String action, String targetType, String targetId, String? reason, DateTime createdAt
});
...
/// Create a copy of AuditLog
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? actorUid = null,Object? actorRole = null,Object? action = null,Object? targetType = null,Object? targetId = null,Object? reason = freezed,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String actorUid,  String actorRole,  String action,  String targetType,  String targetId,  String? reason,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuditLog() when $default != null:
return $default(_that.id,_that.actorUid,_that.actorRole,_that.action,_that.targetType,_that.targetId,_that.reason,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String actorUid,  String actorRole,  String action,  String targetType,  String targetId,  String? reason,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _AuditLog():
return $default(_that.id,_that.actorUid,_that.actorRole,_that.action,_that.targetType,_that.targetId,_that.reason,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String actorUid,  String actorRole,  String action,  String targetType,  String targetId,  String? reason,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _AuditLog() when $default != null:
return $default(_that.id,_that.actorUid,_that.actorRole,_that.action,_that.targetType,_that.targetId,_that.reason,_that.createdAt);case _:
  return null;
...
class _AuditLog implements AuditLog {
  const _AuditLog({required this.id, required this.actorUid, required this.actorRole, required this.action, required this.targetType, required this.targetId, this.reason, required this.createdAt});
...
/// Create a copy of AuditLog
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? actorUid = null,Object? actorRole = null,Object? action = null,Object? targetType = null,Object? targetId = null,Object? reason = freezed,Object? createdAt = null,}) {
